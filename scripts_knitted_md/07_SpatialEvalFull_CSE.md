Spatial Evaluation - Full RF model of raw CSE, alternative km
projections
================
Norah Saarman
2026-04-07
...
- [Step 2. Functions](#step-2-functions)
...
essentially negligible 20 km = small change mean diff ~ 3e-04 → still
tiny 50+ km = real change mean diff jumps to ~ 4e-03 → 1e-02 → 4e-02 →
...
![](../figures/knitted_mds/review-km-projections-1.png)<!-- -->
...
![](../figures/knitted_mds/review-km-projections-2.png)<!-- -->
...
![](../figures/knitted_mds/review-km-projections-3.png)<!-- -->
