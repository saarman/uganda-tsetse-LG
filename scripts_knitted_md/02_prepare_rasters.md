...
ext(pixels_raster)
#SpatExtent : 28.5999999999928, 35.3999999999925, -1.49999999999701, 4.73333333333611 (xmin, xmax, ymin, ymax)
```
...
- `../data_dir/raw/slope_1KMmedian_MERIT_UgandaClip.tif` (GeoTIFF
  template for extent and projection)
- `../data_dir/raw/ne_10m_lakes.shp` (Natural Earth lake shapefile (plus
  .dbf, .shx, .prj))
- `../data_dir/raw/Uganda_rivers_shape.shp` (Uganda river shapefile
  (plus .dbf, .shx, .prj))

# Outputs

- `../data_dir/processed/sample_kernel_density_40km.tif` \# 40 km
  sampling density
- `../data_dir/processed/sample_kernel_density_20km.tif` \# 20 km
  sampling density
- `../data_dir/processed/sample_kernel_density_10km.tif` \# 10 km
  sampling density
- `../data_dir/processed/sample_kernel_density_5km.tif` \# 5 km sampling
  density
- `../data_dir/processed/river_kernel_density_10km.tif` \# 10 km
  river+lake edge density  
- `../data_dir/processed/river_kernel_density_5km.tif` \# 5 km
  river+lake edge density  
- `../data_dir/processed/river_kernel_density_3km.tif` \# 3 km
  river+lake edge density
- `../data_dir/processed/river_kernel_density_2km.tif` \# 2 km
  river+lake edge density  
- `../data_dir/processed/river_kernel_density_1km.tif` \# 1 km
  river+lake edge density  
...
![](../figures/knitted_mds/sampling-1.png)<!-- -->
...
![](../figures/knitted_mds/sampling-2.png)<!-- -->
...
![](../figures/knitted_mds/sampling-3.png)<!-- -->
...
![](../figures/knitted_mds/sampling-4.png)<!-- -->
...
# Save lakes within extent as shapefile
...
![](../figures/knitted_mds/rivers-1.png)<!-- -->
...
![](../figures/knitted_mds/rivers-2.png)<!-- -->
...
![](../figures/knitted_mds/rivers-3.png)<!-- -->
...
![](../figures/knitted_mds/rivers-4.png)<!-- -->
...
![](../figures/knitted_mds/rivers-5.png)<!-- -->
...
![](../figures/knitted_mds/rivers-6.png)<!-- -->
...
![](../figures/knitted_mds/rivers-7.png)<!-- -->
...
![](../figures/knitted_mds/lakes-1.png)<!-- -->
...
![](../figures/knitted_mds/geodist-1.png)<!-- -->
