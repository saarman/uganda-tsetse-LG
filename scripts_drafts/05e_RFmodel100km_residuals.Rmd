---
title: "5b. RF model local (<100 km) \n Residuals (IBD by using LC lakes paths)"
...
writeRaster(prediction_raster, file.path(results_dir,"fullRF100km_residuals.tif"), format = "GTiff", overwrite = TRUE)
```
...
# Load raster layers
con_raster <- rast(file.path(results_dir, "fullRF100km_residuals.tif"))
