...
- [Explore splitting south into
  subclusters](#explore-splitting-south-into-subclusters)
...
```
    ...
    ## Reading layer `ne_10m_lakes' from data source `/tmp/RtmpSh5Lhs/ne_10m_lakes.shp' using driver `ESRI Shapefile'
...
![](06_LOPOCV_files/figure-gfm/plot-1.png)<!-- -->
...
![](06_LOPOCV_files/figure-gfm/plot-2.png)<!-- -->
...
![](06_LOPOCV_files/figure-gfm/unnamed-chunk-1-1.png)<!-- -->
