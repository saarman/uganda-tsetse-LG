...
```{r}
# 1. Convert allelic richness (mean_ar) to a data frame
ar_df <- data.frame(
...
# 2. Convert poppr results (div_stats) to a data frame
...
# 3. 'summary_df' from the hierfstat rarefaction step already has:
#      Population | FIS | Ho | He
#    (no conversion needed)

# 4. Merge all three data frames by "Population"
...
# 5. Save the combined summary to a CSV file
...
# -----------------------------------------------------
# 3. Process the "south" CSE matrix (analogous steps)
# -----------------------------------------------------
...
# -----------------------------------------------------
# 4. Combine "north" and "south" results
# -----------------------------------------------------
