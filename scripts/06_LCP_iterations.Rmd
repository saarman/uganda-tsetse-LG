...
# Inputs  
  ...
  - `/uufs/chpc.utah.edu/common/home/saarman-group1/uganda-tsetse-LG/data/processed/LC_paths.shp` - Least costs paths avoiding lakes for first iteration
...
Overall, I don't think this added complexity is worth it:  
 ...
 - No gain in model performance   
 - No major shift in inferred surface  

# Conclusion:  

Iterative updating of least-cost paths based on model-predicted resistance surfaces resulted in minimal changes to model performance and predicted connectivity, indicating that the initial lake-constrained paths were sufficient.
