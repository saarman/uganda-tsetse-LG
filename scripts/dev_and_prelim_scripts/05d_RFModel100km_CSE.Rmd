---
title: "5a. RF model local (<100 km) \n Raw CSE (LC lakes paths)"
...
writeRaster(prediction_raster, file.path(results_dir,"fullRF100km_CSE.tif"), format = "GTiff", overwrite = TRUE)
```
...
# Load raster layers
con_raster <- rast(file.path(results_dir, "fullRF100km_CSE.tif"))
