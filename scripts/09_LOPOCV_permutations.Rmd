...
```{r permutation-LOPOCV-models, eval = FALSE}
...
GOAL: Calculate an empirical p-value comparing observed vs permuted Pearson's correlation.

```{r empirical-p-lopocv, warning=FALSE}
