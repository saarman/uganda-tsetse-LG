...
Plot: (i) posterior mean migration surface, (ii) posterior mean diversity surface, (iii) residuals surface, plus the observed deme points.
...
```{r eems_plots, fig.width=7, fig.height=10}
plots1$mrates01 +
