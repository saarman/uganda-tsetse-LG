...
```
    ...
    ## -0.10822  0.01846  0.04411  0.03586  0.06420  0.12133
...
```
    ...
    ##     Min.  1st Qu.   Median     Mean  3rd Qu.     Max. 
    ## -0.10822  0.02824  0.05072  0.05100  0.07343  0.12133
...
```
    ...
    ## 1 01-AIN 02-GAN 01-AIN_02-GAN 0.2424627 0.03399388 0.2379571
    ## 2 01-AIN 03-DUK 01-AIN_03-DUK 0.3169412 0.04181803 0.2927262
    ## 3 02-GAN 03-DUK 02-GAN_03-DUK 0.3076377 0.04743900 0.2371950
    ## 4 03-DUK 07-OSG 03-DUK_07-OSG 0.4064882 0.01550402 1.9380024
    ## 5 02-GAN 07-OSG 02-GAN_07-OSG 0.3732382 0.01542288 1.9278604
    ## 6 01-AIN 07-OSG 01-AIN_07-OSG 0.3726589 0.01639576 2.1478446
...
```
    ...
    ##      Min.   1st Qu.    Median      Mean   3rd Qu.      Max. 
    ## -0.056676 -0.020462 -0.010864 -0.007254  0.000663  0.102660
...
```
    ...
    ##     Min.  1st Qu.   Median     Mean  3rd Qu.     Max. 
    ## -24.2274  -7.2344  -2.0159  -3.0513   0.1395  12.4085
...
```
    ...
    ##     Var1   Var2            id        CBER
    ## 1 01-AIN 02-GAN 01-AIN_02-GAN  9419533581
    ## 2 01-AIN 03-DUK 01-AIN_03-DUK  9632565811
    ## 3 02-GAN 03-DUK 02-GAN_03-DUK 10214970679
    ## 4 03-DUK 07-OSG 03-DUK_07-OSG 11059354165
    ## 5 02-GAN 07-OSG 02-GAN_07-OSG 10372220715
    ## 6 01-AIN 07-OSG 01-AIN_07-OSG  8976408184
...
```
    ...
    ##  $ CBER: num  9.42e+09 9.63e+09 1.02e+10 1.11e+10 1.04e+10 ...
...
```
    ...
    ## 1 LCP_mean 1091 0.008008704 0.08949136 0.07121170 0.01243423   0.1115089
    ## 2  LCP_sum 1091 0.007710219 0.08780785 0.06819707 0.04924085  -0.2219028
    ## 3     CBER 1091 0.006522156 0.08075987 0.06532326 0.19574276   0.4424283
