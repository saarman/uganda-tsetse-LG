---
title: "Uganda tsetse prepare rasters"
...
# Inputs
  ...
  - `../data_dir/raw/slope_1KMmedian_MERIT_UgandaClip.tif` (GeoTIFF template for extent and projection)
  - `../data_dir/raw/ne_10m_lakes.shp` (Natural Earth lake shapefile (plus .dbf, .shx, .prj))
  - `../data_dir/raw/Uganda_rivers_shape.shp` (Uganda river shapefile (plus .dbf, .shx, .prj))

# Outputs
  - `../data_dir/processed/sample_kernel_density_40km.tif` # 40 km sampling density
  - `../data_dir/processed/sample_kernel_density_20km.tif` # 20 km sampling density
  - `../data_dir/processed/sample_kernel_density_10km.tif` # 10 km sampling density
  - `../data_dir/processed/sample_kernel_density_5km.tif` # 5 km sampling density
  - `../data_dir/processed/river_kernel_density_10km.tif` # 10 km river+lake edge   density  
  - `../data_dir/processed/river_kernel_density_5km.tif` # 5 km river+lake edge density  
  - `../data_dir/processed/river_kernel_density_3km.tif` # 3 km river+lake edge density 
  - `../data_dir/processed/river_kernel_density_2km.tif` # 2 km river+lake edge density  
  - `../data_dir/processed/river_kernel_density_1km.tif` # 1 km river+lake edge density  
...
```{r rivers, warning=FALSE, results=FALSE, message=FALSE}
