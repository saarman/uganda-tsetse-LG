---
title: "5c. RF model local (<100 km) \n CSE per km (rate, LC lakes paths)"
...
writeRaster(prediction_raster, file.path(results_dir,"fullRF100km_rate.tif"), format = "GTiff", overwrite = TRUE)
```
...
# Load raster layers
con_raster <- rast(file.path(results_dir, "fullRF100km_rate.tif"))
